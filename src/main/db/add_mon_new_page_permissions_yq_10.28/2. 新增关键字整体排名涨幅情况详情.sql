...
VALUES ('每日排名涨幅详情', '/internal/customerkeywordmon/toCustomerKeywordMon', 'fi-thumbnails',
...
INSERT INTO t_role_resource(fRoleID, fResourceID) SELECT tem_role.fUuid, tem_resource.fUuid FROM (
      ...
      (SELECT tr.fUuid FROM t_resource tr WHERE tr.fResourceName = '每日排名涨幅详情') tem_resource);