...
CREATE TABLE `t_industry_info` (
  ...
  `fTerminalType` varchar(50) DEFAULT 'PC' COMMENT '终端类型',
  ...
  `fStatus` tinyint(4) DEFAULT '0' COMMENT '状态 0: 未爬取，1: 爬取中 2: 爬取完',
...
CREATE TABLE `t_industry_detail` (
  ...
  `fWebsite` varchar(100) DEFAULT NULL COMMENT '网站URL',
  `fTitle` varchar(255) DEFAULT NULL COMMENT '标题',
  `fQQ` varchar(200) DEFAULT NULL COMMENT 'QQ',
  `fTelephone` varchar(200) DEFAULT NULL COMMENT '电话',
