...
<form method="post" onsubmit="return checkinput();" action="/user/refundconfirm.jsp">
		...
		<td align="center">
	 	   ...
	 	   <div style="text-align:right;width:700px;"></div>
			 	   ...
			 	   <table width=700 style="font-size:12px;" cellpadding=5>
			 	   	  ...
			 	   	  <tr><td align="right">退款金额:</td> <td><input name="amount" id="amount"  style="width:200px;" type="text"></td></tr>
			 	   	  <tr><td align="right">备注:</td><td><textarea name="remarks" id="remarks" style="width:200px;height:100px"></textarea></td></tr>
		          
		          
		           <tr><td align="right"></td> 
		            	<td>
		            	    <input type="submit" name="btnsub" id="btnsub" value=" 退款 "> &nbsp;&nbsp;&nbsp; <input type="button" onclick="javascript:history.go(-1);" value=" 返回 ">
		            </td>
		           </tr>
		       </table>
  </td>
