...
<div id="topDiv">
    ...
    <form action="/internal/clientstatus/clientStatusGroupStat" method="post" id="searchClientStatusSummaryVOForm" style="margin: 35px 0 5px 10px;">
        ...
        <input id="groupNameFuzzyQuery" name="groupNameFuzzyQuery" type="checkbox" value="groupNameFuzzyQuery" ${clientStatusGroupStatCriteria.groupNameFuzzyQuery != null ? "checked=true" : ""}/>模糊查询
        &nbsp;&nbsp;
        终端类型:
