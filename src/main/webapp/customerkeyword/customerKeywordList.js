...
function saveChangeSetting(CustomerUuids){
    ...
    if(CustomerUuids != null) {
        ...
        var ks = {};
        ks.keyword =isChecked("keyword");
        ks.title = isChecked("title");
        ks.bearPawNumber = isChecked("bearPawNumber");
        ks.url = isChecked("url");
        ks.originalUrl = isChecked("originalUrl");
        ks.optimizePlanCount = isChecked("optimizePlanCount");
        ks.optimizeGroupName =isChecked("optimizeGroupName");
        ks.initialIndexCount = isChecked("initialIndexCount");
        ks.initialPosition =isChecked("initialPosition");
        ks.positionFirstFee =isChecked("positionFirstFee");
        ks.positionSecondFee = isChecked("positionSecondFee");
        ks.positionThirdFee = isChecked("positionThirdFee");
        ks.positionForthFee = isChecked("positionForthFee");
        ks.positionFifthFee = isChecked("positionFifthFee");
        ks.positionFirstPageFee =isChecked("positionFirstPageFee");
        ks.serviceProvider = isChecked("serviceProvider");
        ks.collectMethod =isChecked("collectMethod");
        ks.searchEngine =isChecked("searchEngine");
        ks.sequence =isChecked("sequence");
        ks.orderNumber = isChecked("orderNumber");
        ks.paymentStatus = isChecked("paymentStatus");
        ks.recommendKeywords = isChecked("recommendKeywords");
        ks.negativeKeywords = isChecked("negativeKeywords");
        ks.excludeKeywords = isChecked("excludeKeywords");
        ks.showPage =  isChecked("showPage");
        ks.relatedKeywordPercentage = isChecked("relatedKeywordPercentage");
        ks.remarks =isChecked("remarks");
        ks.positionFirstCost = isChecked("positionFirstCost");
        ks.positionSecondCost = isChecked("positionSecondCost");
        ks.positionThirdCost = isChecked("positionThirdCost");
        ks.positionForthCost = isChecked("positionForthCost");
        ks.positionFifthCost = isChecked("positionFifthCost");
        ks.operateSelectKeyword = isChecked("operateSelectKeyword") === '1' ? 1 : 0;
        ks.operateRelatedKeyword =isChecked("operateRelatedKeyword") === '1' ? 1 : 0;
        ks.operateRecommendKeyword = isChecked("operateRecommendKeyword") === '1' ? 1 : 0;
        ks.operateSearchAfterSelectKeyword = isChecked("operateSearchAfterSelectKeyword") === '1' ? 1 : 0;
        var postData = {};
        postData.ks = ks;
