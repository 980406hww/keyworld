...
<html>
	<head>
		  <title>完整版关键字列表上传</title>
		  <script type="text/javascript" src="/common.js">
		  </script>	  
  	</head>				
<body>

<form method="post" onsubmit="return checkinput();" action="uploadfullconfirm.jsp" enctype="multipart/form-data">
	 	   ...
	 	   <div style="text-align:right;width:100%;font-size:12px;"><a href="/customer/customerlist.jsp">返回客户列表</a></div>
			 	   <table width=80% style="font-size:14px;">
			 	   	<tr><td>
			 	   	   ...
			 	   	   请选择要上传的文件(<font color="red">完整版</font>):<input type="file" id="file" name="file" size=50>
