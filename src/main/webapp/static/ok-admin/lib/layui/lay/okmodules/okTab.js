...
layui.define(["element", "jquery"], function (exports) {
    ...
    okTab.prototype.positionTab = function (contEle, ele) {
        ...
        var marginL = contEle.css('marginLeft');
        var marginR = contEle.css('marginRight');
        var margin = parseInt(marginL.substring(0, marginL.length - 2)) + parseInt(marginR.substring(0, marginR.length - 2));
        var contWidth = contEle.width(),//父级元素宽度
            superWidth = parseInt(superEle.width()) - margin,//可显示的宽度
    ...
    function createMenu(data, tabID) {
        if (data.children != undefined && data.children.length > 0) {
            ...
            temp += '<i class="layui-icon layui-icon-spread-left"></i>';
            ...
            temp += '<i class="layui-icon layui-icon-align-right"></i>';
    ...
    okTab.prototype.navMove = function (moveId, that) {
        var superEle = $(".ok-tab"),//父级元素
            ...
            marginL = contEle.css('marginLeft'),
            marginR = contEle.css('marginRight'),
            margin = parseInt(marginL.substring(0, marginL.length - 2)) + parseInt(marginR.substring(0, marginR.length - 2)),
            superWidth = parseInt(superEle.width()) - margin,//可显示的宽度
