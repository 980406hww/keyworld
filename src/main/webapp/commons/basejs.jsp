...
<%-- [扩展JS] --%>
<script type="text/javascript" src="${staticPath }/static/extJs-min.js" charset="utf-8"></script>
<%-- [扩展样式] --%>
...
<script language="javascript" type="text/javascript" src="${staticPath }/static/jquery.poshytip-min.js"></script>
