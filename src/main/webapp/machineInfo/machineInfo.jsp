...
<head>
    ...
    <script type="text/javascript"
            src="${staticPath}/static/My97DatePicker/WdatePicker.js"></script>
</head>
<body>
<%@ include file="/commons/basejs.jsp" %>
<div id="topDiv">
    <%@ include file="/menu.jsp" %>
    <form id="searchMachineInfoForm" method="post" action="/internal/machineInfo/searchMachineInfos"
          style="font-size: 12px;" cellpadding=3>
        <table style="font-size: 12px;width:100%">
            <tr>
                <td align="left" colspan="2">
                    ...
                    <input type="hidden" name="startUpStatusHidden" id="startUpStatusHidden"
                           value="${machineInfoCriteria.startUpStatus}"/>
                    <input type="hidden" name="runningProgramTypeHidden"
                           id="runningProgramTypeHidden"
                           value="${machineInfoCriteria.runningProgramType}"/>
                    <input type="hidden" name="hiddenColumns" id="hiddenColumns"
                           value="${machineInfoCriteria.hiddenColumns}"/>
                    <input type="hidden" name="haveHiddenColumns" id="haveHiddenColumns"
                           value="${machineInfoCriteria.haveHiddenColumns}"/>
                    客户端ID:<input type="text" name="clientID" id="clientID"
                                 value="${machineInfoCriteria.clientID}" style="width: 90px;">
                    &nbsp;&nbsp;
                    &nbsp;
                    机器分组:
                    <input type="text" name="machineGroup" id="machineGroup"
                           value="${machineInfoCriteria.machineGroup}" style="width:100px;">&nbsp;
                    <input id="machineGroupFuzzyQuery" name="machineGroupFuzzyQuery" type="checkbox"
                           onclick="machineGroupFuzzyQueryValue()"
                           value="${machineInfoCriteria.machineGroupFuzzyQuery}" ${machineInfoCriteria.machineGroupFuzzyQuery=='1' ? 'checked' :''} />模糊查询
                    &nbsp;
                    &nbsp;
                    版本:<input type="text" name="version" id="version"
                              value="${machineInfoCriteria.version}" style="width: 40px;">
                    &nbsp;&nbsp;
                    目标版本:<input type="text" name="targetVersion" id="targetVersion"
                                value="${machineInfoCriteria.targetVersion}" style="width: 40px;">
                    &nbsp;&nbsp;
                    城市:<input type="text" name="city" id="city" value="${machineInfoCriteria.city}"
                              style="width: 120px;">
                    &nbsp;&nbsp;
                    失败原因:<input type="text" name="upgradeFailedReason" id="upgradeFailedReason"
                                value="${machineInfoCriteria.upgradeFailedReason}"
                                style="width: 50px;">
                    &nbsp;&nbsp;
                    </select>
                    &nbsp;&nbsp;
                    服务器ID:<input type="text" name="vpsBackendSystemComputerID"
                                 id="vpsBackendSystemComputerID"
                                 value="${machineInfoCriteria.vpsBackendSystemComputerID}"
                                 style="width: 80px;">
                    &nbsp;&nbsp;
                    流转分组:<input type="text" name="switchGroupName" id="switchGroupName"
                                value="${machineInfoCriteria.switchGroupName}"
                                style="width: 100px;">
                    &nbsp;&nbsp;
                    内存
                    <input type="text" name="gtMemory" id="gtMemory" placeholder=">=" value="${machineInfoCriteria.gtMemory}" style="width:40px;"/>
                    <input type="text" name="ltMemory" id="ltMemory" placeholder="<=" value="${machineInfoCriteria.ltMemory}" style="width:40px;"/>
                    排序:<select name="orderBy" id="orderBy">
                    <option value=""></option>
                    <c:forEach items="${orderByMap}" var="entry">
                        <c:choose>
                            <c:when test="${entry.key eq machineInfoCriteria.orderBy}">
            ...
            <tr>
                <td align="left">
                    <input id="hasProblem" name="hasProblem" type="checkbox"
                           value="hasProblem" ${machineInfoCriteria.hasProblem != null ? "checked=true" : ""}>停了</input>
                    &nbsp;&nbsp;
                    <input id="renewal" name="renewal" type="checkbox"
                           value="renewal" ${machineInfoCriteria.renewal != null ? "checked=true" : ""}>续费</input>
                    &nbsp;&nbsp;
                    <input id="hasMachineGroup" name="hasMachineGroup" type="checkbox"
                           value="hasMachineGroup" ${machineInfoCriteria.hasMachineGroup != null ? "checked=true" : ""}
                           onclick="uncheckedAnother('hasMachineGroup')">有机器分组</input>
                    &nbsp;&nbsp;
                    <input id="noMachineGroup" name="noMachineGroup" type="checkbox"
                           value="noMachineGroup" ${machineInfoCriteria.noMachineGroup != null ? "checked=true" : ""}
                           onclick="uncheckedAnother('noMachineGroup')">没机器分组</input>
                    &nbsp;&nbsp;
                    <input id="noVNC" name="noVNC" type="checkbox"
                           value="noVNC" ${machineInfoCriteria.noVNC != null ? "checked=true" : ""}>没VNC</input>
                    &nbsp;&nbsp;
                    <input id="noUpgrade" name="noUpgrade" type="checkbox"
                           value="noUpgrade" ${machineInfoCriteria.noUpgrade != null ? "checked=true" : ""}>没升级</input>
                    &nbsp;&nbsp;
                    <input id="noChangePassword" name="noChangePassword" type="checkbox"
                           value="noChangePassword" ${machineInfoCriteria.noChangePassword != null ? "checked=true" : ""}>没修改密码</input>
                    &nbsp;&nbsp;
                    <input id="startUpClient" name="startUpClient" type="checkbox"
                           value="startUpClient" ${machineInfoCriteria.startUpClient != null ? "checked=true" : ""}>开机机器</input>
                    &nbsp;&nbsp;
                    <input id="showFetchKeywordStatus" name="showFetchKeywordStatus" type="checkbox"
                           value="showFetchKeywordStatus"
                    ...
                    <c:forEach items="${validMap}" var="entry">
                        <c:choose>
                            <c:when test="${entry.value eq machineInfoCriteria.valid}">
                    ...
                    <shiro:hasPermission name="/internal/machineInfo/updateMachineGroup">
                        <input type="button" onclick="batchUpdateMachineGroup('selected')"
                               value="修改所选终端机器分组">
                        <input type="button" onclick="batchUpdateMachineGroup('total')"
                               value="修改当前终端机器分组">
                    </shiro:hasPermission>
            ...
            <tr>
                <td colspan="2" align="right">
                    <shiro:hasPermission
                        name="/internal/machineInfo/updateMachineInfoTargetVersion">
                        <a target="_blank" href="javascript:showTargetVersionSettingDialog(this)">设定目标版本</a>
                    </shiro:hasPermission>
                    <shiro:hasPermission name="/internal/machineInfo/saveMachineInfo">
                        <a target="_blank"
                           href="javascript:showTargetVPSPasswordSettingDialog(this)">设定目标密码</a>
                    </shiro:hasPermission>
                    ...
                    <shiro:hasPermission
                        name="/internal/machineInfo/resetRestartStatusForProcessing">
    ...
    <table width=100% style="font-size: 12px" id="headerTable">
        <tr bgcolor="#eeeeee" height=30>
            <td align="center" width=10><input type="checkbox" onclick="selectAll(this)"
                                               id="selectAllChecked"/></td>
            ...
            <td align="center" width=50>cpu核数<br>内存</td>
...
<div id="machineInfoDiv" style="margin-bottom: 30px;">
    <table width=100% style="font-size: 12px" id="machineInfoTable">
        <c:forEach items="${page.records}" var="machineInfo" varStatus="tr">
            ...
            <td align="center" width=10><input type="checkbox" name="clientID"
                                               value="${machineInfo.clientID}"
                                               onclick="decideSelectAll()"/></td>
            <td width=40>
            ...
            <td width=40>
                ...
                <input type="text"
                       value="${machineInfo.machineGroup == null ? "" : machineInfo.machineGroup}"
                       name="machineGroup" id="${machineInfo.clientID}"
                       onBlur="updateMachineGroup(this)" style="width: 100%;"/>
            </td>
            <td width=20><font color="${keywordColor}"><fmt:formatDate
                value="${machineInfo.renewalDate}"
                pattern="MM-dd"/></font></td>
            <td width=30><font
                color="${keywordColor}">${machineInfo.version == null ? "" : machineInfo.version}<br>${machineInfo.targetVersion == null ? "" : machineInfo.targetVersion}
            </font>
            </td>
            <td width=40><font
                color="${keywordColor}">${machineInfo.restartCount}/${machineInfo.restartStatus == null ? "" : machineInfo.restartStatus}<br>${machineInfo.continuousFailCount}
            </font>
            </td>
            <td width=60 style="word-break: break-all;"><font
                color="${keywordColor}">${machineInfo.city == null ? "" : machineInfo.city}<br>${machineInfo.status == null ? "" : machineInfo.status}
            </font>
            </td>
            <td width=30><font
                color="${keywordColor}">${machineInfo.cpuCount}<br>${machineInfo.memory}</font></td>
            <td width=30><font color="${keywordColor}">${machineInfo.freeSpace}</font></td>
            <td width=40><font color="${keywordColor}"><fmt:formatDate
                value="${machineInfo.lastVisitTime}"
                pattern="MM-dd HH:mm"/><br><fmt:formatDate
                value="${machineInfo.restartTime}" pattern="MM-dd HH:mm"/></font></td>
            <td width=40><font color="${keywordColor}"><fmt:formatDate
                value="${machineInfo.restartOrderingTime}"
                pattern="MM-dd HH:mm"/><br><fmt:formatDate
                value="${machineInfo.lastSendNotificationTime}" pattern="MM-dd HH:mm"/></font></td>
            <td width=30><font
                color="${keywordColor}">${machineInfo.optimizationSucceedCount}<br>${machineInfo.optimizationTotalCount}
            </font>
            </td>
            <td width=50><font
                color="${keywordColor}">${machineInfo.broadbandAccount}<br>${machineInfo.broadbandPassword}
            </font></td>
            <td width=30><font color="${keywordColor}">${machineInfo.runningProgramType}</font></td>
            <td width=40><font
                color="${keywordColor}">${machineInfo.startUpStatus}<br>${machineInfo.downloadProgramType}
            </font></td>
            <td width=20><font color="${keywordColor}">${machineInfo.valid ? "监控中" : "暂停监控"}</font>
            </td>
            <td width=40>
                <shiro:hasPermission name="/internal/machineInfo/updateUpgradeFailedReason">
                    <input type="text"
                           ...
                           name="upgradeFailedReason" id="${machineInfo.clientID}"
                           onBlur="updateUpgradeFailedReason(this)"
                           style="width: 100%;"/>
                </shiro:hasPermission>
            </td>
            <td width=40><font
                color="${keywordColor}">${machineInfo.vpsBackendSystemComputerID}</font></td>
            <td width=80>
                <c:choose>
...
<div id="showCustomerBottomPositioneDiv">
    <div id="showCustomerBottomDiv">
        ...
        <input type="text" value="${page.current}" style="width:30px;"
               onchange="changePaging(this.value,'${page.size}')">/${page.pages}&nbsp;&nbsp;
            ...
            <td>
                <table id="td_1" style="font-size:12px">
                    ...
                    <tr name="trItem" onclick="checkItem(this)">
                        <th>VPS后台系统电脑ID</th>
                        <td>
                            <input type="text" name="vpsBackendSystemComputerID"
                                   id="vpsBackendSystemComputerID"/>
                        </td>
                    </tr>
                    <tr name="trItem" onclick="checkItem(this)">
                        <th>VPS后台系统密码</th>
                        <td>
                            <input type="text" name="vpsBackendSystemPassword"
                                   id="vpsBackendSystemPassword"/>
                        </td>
                    </tr>
                    <tr name="trItem" onclick="checkItem(this)">
                        <th>宽带账号</th>
                        <td>
                            <input type="text" name="broadbandAccount" id="broadbandAccount"
                                   value=""/>
                        </td>
                    </tr>
                    <tr name="trItem" onclick="checkItem(this)">
                        <th>宽带密码</th>
                        <td>
                            <input type="text" name="broadbandPassword" id="broadbandPassword"
                                   value=""/>
                        </td>
                    </tr>
                </table>
...
<div id="renewalSettingDialog" class="easyui-dialog" style="display: none;left: 40%;">
    <table style="font-size:12px">
        ...
        <tr>
            <th>日期</th>
            <td>
                <input name="renewalDate" id="renewalDate" class="Wdate" type="text"
                       style="width:160px;" onClick="WdatePicker()" value="">
            </td>
        </tr>
    </table>
</div>
            ...
            <tr>
                <td align="right">
                    <table width="100%" style="font-size:14px;">
                        <tr>
                            <td>
                                <input type="file" id="file" name="file" size=50 height="50px"
                                       style="width: 260px;">
                            </td>
                        </tr>
                    </table>
...
<div id="headerTableDialog" class="easyui-dialog" style="display: none">
    <table>
        <tr>
            <td><input type="checkbox" name="columnName" id="1">客户端ID</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="4">续费日期</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="5">现版本-目标版本</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="6">重启数/重启状态-失败次数</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="7">所在城市-终端状态</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="8">剩余空间</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="9">最新工作时间-重启时间</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="10">重启排序时间-发通知时间</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="11">成功次数-操作次数</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="12">宽带账号-宽带密码</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="13">运行程序-类型</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="14">开机状态-下载程序类型</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="15">状态</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="16">失败原因</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="17">服务器ID</td>
        </tr>
        <tr>
            <td><input type="checkbox" name="columnName" id="18">操作</td>
        </tr>
    </table>
</div>
<%--Dialog部分--%>
<div id="targetMachineGroupDialog" style="text-align: center;left: 40%;display: none;">
    <form id="targetMachineGroupForm" style="text-align: center;margin-top: 10px;"
        ...
        机器分组:<input type="text" id="targetMachineGroup" name="targetMachineGroup"
