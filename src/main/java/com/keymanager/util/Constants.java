...
public class Constants {
	...
	static {
		operationTypeMap.put(TerminalTypeEnum.PC.name(), new String[]{"",
				...
				"pc_pm_zhidao", "pc_pm_wenku", "pc_tieba", "pc_kpm", "pc_xl_sogou"});
		operationTypeMap.put(TerminalTypeEnum.Phone.name(), new String[]{"", "m_pm", "m_xl", "m_xg", "m_pm_sm", "m_xl2", "m_kpm", "m_xl_sogou"});
	}
