...
public class CustomerKeywordForOptimization {
	...
	public int getKuaizhaoPercent() {
		return kuaizhaoPercent;
	}

	public void setKuaizhaoPercent(int kuaizhaoPercent) {
		this.kuaizhaoPercent = kuaizhaoPercent;
	}

	public int getBaiduSemPercent() {
		return baiduSemPercent;
	}

	public void setBaiduSemPercent(int baiduSemPercent) {
		this.baiduSemPercent = baiduSemPercent;
	}

	public int getDragPercent() {
		return dragPercent;
	}

	public void setDragPercent(int dragPercent) {
		this.dragPercent = dragPercent;
	}

	public int getMultiBrowser() {
		return multiBrowser;
	}

	public void setMultiBrowser(int multiBrowser) {
	...
	public int getZhanneiPercent() {
		return zhanneiPercent;
	}

	public void setZhanneiPercent(int zhanneiPercent) {
	...
	public int getOpenStatistics() {
		return openStatistics;
	}

	public void setOpenStatistics(int openStatistics) {
