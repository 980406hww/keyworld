...
import com.keymanager.monitoring.excel.definition.CustomerKeywordDailyReportSecondDefinition;
...
//		writer.setCurrentWorkSheetWithName("Default");
  ...
  public byte[] getExcelContentBytes() throws Exception {
	...
	private void writeDailyTitle(int rowIndex) throws ExcelWriteException{
		...
		writer.addLabelCell(CustomerKeywordDailyReportSecondDefinition.URL.getColumnIndex(), rowIndex, CustomerKeywordDailyReportSecondDefinition.URL.getTitle(), true);
		...
		writer.addLabelCell(CustomerKeywordDailyReportSecondDefinition.Price1.getColumnIndex(), rowIndex, CustomerKeywordDailyReportSecondDefinition.Price1.getTitle(), true);
		price1Width = calculateWidth(price1Width, CustomerKeywordDailyReportSecondDefinition.Price1.getTitle());
		writer.addLabelCell(CustomerKeywordDailyReportSecondDefinition.Price4.getColumnIndex(), rowIndex, CustomerKeywordDailyReportSecondDefinition.Price4.getTitle(), true);
