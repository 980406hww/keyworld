...
public interface TSNegativeKeywordDao extends BaseMapper<TSNegativeKeyword> {
    ...
    List<TSMainKeywordVO> complaintsReportContentPC2weeks();//获取需要发送邮件的内容
    List<TSMainKeywordVO> complaintsReportContentPhone2weeks();//获取需要发送邮件的内容
    List<TSMainKeywordVO> complaintsReportContentPC3times();//获取需要发送邮件的内容
    List<TSMainKeywordVO> complaintsReportContentPhone3times();//获取需要发送邮件的内容
}
