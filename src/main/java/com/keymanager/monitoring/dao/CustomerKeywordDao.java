...
public interface CustomerKeywordDao extends BaseMapper<CustomerKeyword> {
    ...
    List<CustomerKeyword> searchCustomerKeywords(@Param("customerKeywordCrilteria") CustomerKeywordCrilteria customerKeywordCrilteria);
    ...
    void adjustOptimizationCount(@Param("customerKeywordUuid")Long customerKeywordUuid, @Param("optimizationPlanCount")int optimizationPlanCount,
