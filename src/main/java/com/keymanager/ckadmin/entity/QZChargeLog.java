...
public class QZChargeLog extends BaseEntity {
    ...
    public QZChargeLog(Long qzOperationTypeUuid, Date planChargeDate, Date actualChargeDate,
        BigDecimal receivableAmount, BigDecimal actualAmount, String loginName) {
