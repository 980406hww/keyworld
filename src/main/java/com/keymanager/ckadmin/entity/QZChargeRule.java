...
/**
 * Created by shunshikj01 on 2017/7/7. 收费规则
 */
...
public class QZChargeRule extends BaseEntity {
    ...
    public QZChargeRule(Long qzOperationTypeUuid, Integer startKeywordCount,
        Integer endKeywordCount, Integer amount, String standardSpecies) {
        this.qzOperationTypeUuid = qzOperationTypeUuid;
        this.startKeywordCount = startKeywordCount;
        this.endKeywordCount = endKeywordCount;
        this.amount = amount;
