...
public interface CustomerKeywordService extends IService<CustomerKeyword> {
    ...
    void updateCustomerKeywordPosition(Long customerKeywordUuid, int position, int existsTimestamp, Date capturePositionQueryTime, String ip, String city,String captureType);
