...
import com.keymanager.ckadmin.excel.definition.CustomerCollectFeeWithLogDefinition;
...
public class CustomerCollectFeeWithLogExcelWriter {
    ...
    private void writeCollectFeeRow(int rowIndex, CustomerKeywordPositionView view) throws ExcelWriteException {
        ...
        writer.addLabelCell(CustomerCollectFeeWithLogDefinition.Date.getColumnIndex(), rowIndex,
            view.getCreateDate() != null ? view.getCreateDate().toString() : "");
