...
import com.keymanager.ckadmin.excel.definition.CustomerKeywordInfoDefinition;
...
public class CustomerKeywordInfoExcelWriter {
    ...
    private void writeRow(int rowIndex, CustomerKeyword view) throws ExcelWriteException {
        ...
        writer.addLabelCell(CustomerKeywordInfoDefinition.OriginalPosition.getColumnIndex(), rowIndex,
