...
public class CustomerKeywordDailyReportTotalExcelWriter {
    ...
    public void writeDailyTotalTitle(int rowIndex) throws ExcelWriteException {
        ...
        writer.addLabelCell(CustomerKeywordDailyReportSummaryDefinition.BaiduPhone.getColumnIndex(), rowIndex,
            CustomerKeywordDailyReportSummaryDefinition.BaiduPhone.getTitle(), true);
        ...
        writer.addLabelCell(CustomerKeywordDailyReportSummaryDefinition.SogouPhone.getColumnIndex(), rowIndex,
            CustomerKeywordDailyReportSummaryDefinition.SogouPhone.getTitle(), true);
        ...
        writer
            .addLabelCell(CustomerKeywordDailyReportSummaryDefinition.So.getColumnIndex(), rowIndex, CustomerKeywordDailyReportSummaryDefinition.So.getTitle(),
                true);
        ...
        writer
            .addLabelCell(CustomerKeywordDailyReportSummaryDefinition.UC.getColumnIndex(), rowIndex, CustomerKeywordDailyReportSummaryDefinition.UC.getTitle(),
                true);
        ...
        writer.addLabelCell(CustomerKeywordDailyReportSummaryDefinition.BingCN.getColumnIndex(), rowIndex,
            CustomerKeywordDailyReportSummaryDefinition.BingCN.getTitle(), true);
