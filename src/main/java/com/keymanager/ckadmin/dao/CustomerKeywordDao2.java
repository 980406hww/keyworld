...
CustomerKeywordDao2 extends BaseMapper<com.keymanager.ckadmin.entity.CustomerKeyword> {
    ...
    void cleanCustomerTitle(@Param("terminalType") String terminalType, @Param("entryType") String entryType,
            @Param("customerUuid") String customerUuid);

    void cleanCaptureTitleFlag(@Param("terminalType") String terminalType, @Param("entryType") String entryType,
            @Param("customerUuid") String customerUuid);

    void cleanCaptureTitleBySelected(@Param("customerKeywordUuids") List<String> customerKeywordUuids);

    int getCustomerKeywordCount(@Param("terminalType") String terminalType, @Param("entryType") String entryType,
            @Param("customerUuid") long customerUuid);
    ...
    int getSimilarCustomerKeywordCount(@Param("terminalType") String terminalType,
            @Param("customerUuid") long customerUuid, @Param("keyword") String
    ...
    Integer getSameCustomerKeywordCount(@Param("terminalType") String terminalType,
            @Param("customerUuid") long customerUuid, @Param("keyword") String keyword, @Param("url") String url,
            @Param("title") String title);

    int getMaxSequence(@Param("terminalType") String terminalType, @Param("entryType") String entryType,
            @Param("customerUuid") long customerUuid);

    List<CustomerKeyword> searchSameCustomerKeywords(@Param("terminalType") String terminalType,
            @Param("customerUuid") long customerUuid,
    ...
    List<CustomerKeyword> searchCustomerKeywordsPage(Page<CustomerKeyword> page,
            @Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);

    List<CustomerKeyword> searchCustomerKeywordsPageForCustomer(Page<CustomerKeyword> page,
            @Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);

    List<CustomerKeyword> searchCustomerKeywordInfo(
            @Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);

    int searchCustomerKeywordsCount(@Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);

    List<CustomerKeyword> searchCustomerKeywordsForDailyReport(
            @Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);

    void deleteCustomerKeywordsByUuid(@Param("customerKeywordUuids") List<String> customerKeywordUuids);

    List<Map> selectAllKeywordAndUrl(@Param("customerUuid") Long customerUuid,
            @Param("terminalType") String terminalType);

    //重构部分
    //修改该用户关键字组名
    void updateCustomerKeywordGroupName(
            @Param("customerKeywordUpdateCriteria") CustomerKeywordUpdateCriteria customerKeywordUpdateCriteria);

    void updateCustomerKeywordSearchEngine(
            @Param("customerKeywordUpdateCriteria") CustomerKeywordUpdateCriteria customerKeywordUpdateCriteria);

    void updateCustomerKeywordGroupNameByRank(@Param("customerKeywordUuids") List<Long> customerKeywordUuids,
    ...
    void deleteCustomerKeywordsWhenEmptyTitleAndUrl(@Param("terminalType") String terminalType,
            @Param("entryType") String entryType, @Param("customerUuid") String customerUuid);

    void deleteCustomerKeywordsWhenEmptyTitle(@Param("terminalType") String terminalType,
            @Param("entryType") String entryType, @Param("customerUuid") String customerUuid);

    void deleteCustomerKeywordsByCustomerUuid(@Param("customerUuid") Long customerUuid);

    void deleteCustomerKeywords(@Param("terminalType") String terminalType, @Param("groupName") String groupName,
            @Param("keyword") String keyword);

    List<String> getGroups(@Param("customerUuids") List<Long> customerUuids);

    List<Map> searchRemainingOptimizationCount(@Param("groupName") String groupName,
            @Param("maxInvalidCount") int maxInvalidCount,
            @Param("noPositionMaxInvalidCount") int noPositionMaxInvalidCount);
    ...
    Long getCustomerKeywordUuidForOptimization(@Param("terminalType") String terminalType,
            @Param("groupName") String groupName, @Param("bigKeyword") boolean bigKeyword);
    ...
    void updateOptimizationQueryTimeSingle(@Param("customerKeywordUuid") Long customerKeywordUuid,
            @Param("maxInvalidCount") int maxInvalidCount);
    ...
    void adjustOptimizePlanCount(@Param("customerKeywordUuid") Long customerKeywordUuid,
            @Param("optimizationPlanCount") int optimizationPlanCount,
            @Param("queryInterval") int queryInterval);

    Long getCustomerKeywordUuidForCapturePosition(@Param("terminalType") String terminalType,
    ...
    List<Long> getCustomerKeywordUuidForCapturePositionTemp(@Param("qzSettingUuid") Long qzSettingUuid,
            @Param("terminalType") String terminalType,
    ...
    void resetInvalidRefreshCount(
            @Param("customerKeywordRefreshStatInfoCriteria") CustomerKeywordRefreshStatInfoCriteria customerKeywordRefreshStatInfoCriteria);
    ...
    CustomerKeyword searchTitleAndUrl(@Param("groupNames") String[] groupNames,
            @Param("customerUuid") Long customerUuid);
    ...
    SearchEngineResultVO getCustomerKeywordForAutoUpdateNegative(@Param("terminalType") String terminalType,
            @Param("groupName") String groupName);

    void updateAutoUpdateNegativeTime(@Param("terminalType") String terminalType, @Param("groupName") String groupName,
            @Param("keyword") String keyword);

    void updateAutoUpdateNegativeTimeAs4MinutesAgo(@Param("terminalType") String terminalType,
            @Param("groupName") String groupName);

    List<Long> searchCustomerKeywordsUuidForCaptureTitle(
            @Param("qzCaptureTitleLog") QZCaptureTitleLog qzCaptureTitleLog, @Param("searchEngine") String searchEngine,
    ...
    List<CustomerKeywordSummaryInfoVO> searchCustomerKeywordSummaryInfo(@Param("entryType") String entryType,
            @Param("customerUuid") Long customerUuid);
    ...
    void updatePosition(@Param("uuid") Long uuid, @Param("position") Integer position,
            @Param("capturePositionQueryTime") Date capturePositionQueryTime, @Param("todayFee") Double todayFee,
            @Param("ip") String ip, @Param("city") String city);

    List<OptimizationCountVO> takeOptimizationCountExceptionUsers();

    List<String> fetchOptimizationCompletedGroupNames(@Param("typesStr") String typesStr,
            @Param("maxInvalidCount") Integer maxInvalidCount);
    ...
    void editCustomerOptimizePlanCount(@Param("optimizePlanCount") Integer optimizePlanCount,
            @Param("settingType") String settingType, @Param("uuids") List<String> uuids);

    void editOptimizePlanCountByCustomerUuid(@Param("terminalType") String terminalType,
            @Param("entryType") String entryType, @Param("customerUuid") Long customerUuid,
            @Param("optimizePlanCount") Integer optimizePlanCount, @Param("settingType") String settingType);
    ...
    void batchChangeCustomerKeywordStatus(@Param("entryType") String entryType,
            @Param("customerUuids") List<Long> customerUuids, @Param("status") Integer status);
    ...
    int searchCustomerKeywordForNoReachStandard(
            @Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);

    void batchUpdateOptimizedCount(@Param("customerKeywordUuids") List<Long> customerKeywordUuids);

    List<NegativeList> getCustomerKeywordSummaryInfos(@Param("terminalType") String terminalType,
            @Param("keyword") String keyword);

    List<KeywordSimpleVO> getQZCustomerKeywordSummaryInfos(@Param("terminalType") String terminalType,
            @Param("optimizeGroupName") String optimizeGroupName);

    List<String> searchKeywordUrlByGroup(@Param("terminalType") String terminalType,
            @Param("entryType") String entryType, @Param("optimizeGroupName") String optimizeGroupName);

    void batchUpdatePosition(@Param("terminalType") String terminalType, @Param("entryType") String entryType,
            @Param("searchEngine") String searchEngine, @Param("reachStandardPosition") int reachStandardPosition,
            @Param("positionVOs") List<PositionVO> positionVOs);

    String getBearPawNumberByCustomerUuid(@Param("customerUuid") int customerUuid, @Param("entryType") String entryType,
            @Param("terminalType") String terminalType);

    void batchUpdateRequireDalete(
            @Param("requireDeleteKeywordVOs") List<RequireDeleteKeywordVO> requireDeleteKeywordVOs);

    void updateCustomerKeywordQueryTime(@Param("customerKeywordUuid") Long customerKeywordUuid,
            @Param("capturePositionQueryTime") Date capturePositionQueryTime);

    void updateKeywordCustomerUuid(@Param("keywordUuids") List<String> keywordUuids,
            @Param("customerUuid") String customerUuid, @Param("terminalType") String terminalType);

    List<String> getCustomerKeywordInfo(
            @Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);
    void moveOutNoRankingCustomerKeyword(@Param("monitorConfigs") List<String> monitorConfigs,
            @Param("noRankOptimizeGroupNameConfigType") String noRankOptimizeGroupNameConfigType);

    void moveOutDefaultCustomerKeyword(@Param("noRankConfigs") List<Config> noRankConfigs,
            @Param("defaultOptimizeGroupNameConfigType") String defaultOptimizeGroupNameConfigType);

    List<CustomerKeywordSortVO> sortCustomerKeywordForOptimize(@Param("monitorConfigs") List<String> monitorConfigs);

    void setNoRankingCustomerKeyword(@Param("needMoveUuids") List<String> needMoveUuids,
            @Param("noRankOptimizeGroupNameConfigType") String noRankOptimizeGroupNameConfigType);

    void updateCustomerKeywordCt(@Param("customerKeywordUuid") Long customerKeywordUuid, @Param("ct") String ct);

    void updateCustomerKeywordFromSource(@Param("customerKeywordUuid") Long customerKeywordUuid,
            @Param("fromSource") String fromSource);

    List<CustomerKeyword> searchCustomerKeywordsPageForCustomer(
            @Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);

    //客户关键字批量设�
    void batchUpdateKeywordStatus(@Param("keywordIDs") String[] keywordIDs,
            @Param("keywordChecks") CustomerKeyword keywordChecks,
            @Param("keywordStatus") CustomerKeyword keywordStatus);

    void updateCustomerKeywordsTitle(
            @Param("searchEngineResultItemVOs") List<SearchEngineResultItemVO> searchEngineResultItemVOs);
    List<String> searchDuplicateKeywords(
            @Param("customerKeywordCriteria") CustomerKeywordCriteria customerKeywordCriteria);
    ...
    List<String> getAvailableOptimizationGroups(
    ...
    void updateSameCustomerKeywordSource(@Param("terminalType") String terminalType,
            @Param("customerUuid") long customerUuid, @Param("keyword") String keyword, @Param("url") String url,
            @Param("title") String title, @Param("customerKeywordSource") String customerKeywordSource);
    ...
    void updateCustomerKeywordEffect(@Param("customerUuid") long customerUuid,
            @Param("terminalType") String terminalType, @Param("optimizeGroupName") String optimizeGroupName);
    ...
    List<OptimizationKeywordVO> fetchCustomerKeywordsForCache(@Param("terminalType") String terminalType,
            @Param("machineGroup") String machineGroup, @Param("batchCount") int batchCount);

    CustomerKeywordRankingCountVO getCustomerKeywordRankingCount(@Param("customerUuid") int customerUuid,
            @Param("groupName") String groupName);
    ...
    List<keywordAmountCountVo> searchKeywordAmountCountList(Page<keywordAmountCountVo> customerKeywordPage,
            @Param("keywordAmountCountCriteria") KeywordAmountCountCriteria keywordAmountCountCriteria);
