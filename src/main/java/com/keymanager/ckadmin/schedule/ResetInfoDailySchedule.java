...
public class ResetInfoDailySchedule {
	...
	public void runTask(){
		...
		try {
			...
			customerKeywordService.updateRepeatedCustomerKeywordOptimizeStatus("整站销售部", invalidMaxDays);
			customerKeywordService.updateRepeatedCustomerKeywordOptimizeStatus("优化部", invalidMaxDays);
